...
export function MaleDoctor2Avatar(...props) {
  const { animations } = useGLTF("summaryAnimations/MaleDoctor2-Animations.glb");
  const { nodes, materials, scene } = useGLTF("glb/MaleDoctor2.glb");
