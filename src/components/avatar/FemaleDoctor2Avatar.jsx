...
export function FemaleDoctor2Avatar(...props) {
  const { animations } = useGLTF("summaryAnimations/FemaleDoctor2-Animations.glb");
  const { nodes, materials, scene } = useGLTF("glb/FemaleDoctor2.glb");
