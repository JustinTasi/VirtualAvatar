...
export function FemaleDoctor1Avatar(...props) {
  const { animations } = useGLTF("summaryAnimations/FemaleDoctor1-Animations.glb");
  const { nodes, materials, scene } = useGLTF("glb/FemaleDoctor1.glb");
